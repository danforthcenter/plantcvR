...
databases = c("TM007_E_082415_results.sqlite", "TM008_results.sqlite", "TM010_E_103015_results.sqlite",
              "TM011_E_110915_results.sqlite")
for (db in databases) {
  ## Database driver
  drv <- dbDriver("SQLite")
  # Connect to database
  ...
  write.csv(plantcv.data, paste(db, ".csv", sep = ""), row.names = FALSE, quote = FALSE)  
