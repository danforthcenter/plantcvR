...
water.data[water.data$measurement.label == "TM015_F_051616",]$dap = 
  as.numeric(water.data[water.data$measurement.label == "TM015_F_051616",]$date - 
               lt1a_planting_date)
water.data[water.data$measurement.label == "TM016_F_052716",]$dap = 
  as.numeric(water.data[water.data$measurement.label == "TM016_F_052716",]$date - 
               lt1b_planting_date)
