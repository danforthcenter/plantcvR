...
traits <- read.table(file = "NAM.traits.csv", sep = ",", header = TRUE)
water.data <- read.table(file = "NAM.water.data.csv", sep = ",", header = TRUE)
...
non.num.traits.avg <- seq_along(traits.avg)[seq_along(traits.avg) %in% numeric.traits.avg]
